...
const dictionary: Record<Locale, Dictionary> = {
	es: {
		...
		mission: {
			...
			values: [
				{
					title: 'Diseño humano',
					description: 'Creamos experiencias empáticas centradas en las necesidades reales.'
				},
				{
					title: 'Tecnología práctica',
					description: 'Cada funcionalidad existe para resolver un problema concreto del día a día.'
				},
				{
					title: 'Experiencias inclusivas',
					description: 'Construimos con diversidad en mente para que nadie se quede fuera.'
				}
			]
		},
		products: {
			title: 'Nuestros productos',
			caption: 'Dos aplicaciones con una visión compartida: cuidar y proteger a las personas.',
			cards: [
				{
					name: 'Sefone',
					status: 'available',
		...
		roadmap: {
			title: 'Roadmap 2025',
			caption: 'Hitos que nos guían para lanzar y evolucionar nuestras experiencias.',
			items: [
				{
					quarter: 'Q1 2025',
					title: 'Lanzamiento de Sefone en iOS y Android',
					description: 'Experiencia completa con rutinas solares y alertas hiperlocales.',
					product: 'sefone'
				},
				{
					quarter: 'Q2 2025',
					title: 'Beta cerrada de Minervax',
					description: 'Inicio de la red colaborativa con comunidades piloto en la Ciudad de México.',
					product: 'minervax'
				},
				{
					quarter: 'Q3 2025',
					title: 'Reportes UV comunitarios',
					description: 'Usuarios de Sefone envían observaciones que enriquecen los datos meteorológicos.',
					product: 'sefone'
				},
				{
					quarter: 'Q4 2025',
					title: 'Alertas colaborativas y widgets de Minervax',
					description: 'Acceso rápido a alertas críticas desde la pantalla principal y dispositivos wearables.',
					product: 'minervax'
				}
			]
		},
		...
		team: {
			...
			founder: {
				name: 'Miguel Toeldano',
				role: 'Founder',
				bio: 'Ingeniero de software y diseñador de producto. Impulsa experiencias que combinan bienestar, seguridad y tecnología accesible.',
				placeholder: 'https://placehold.co/400x400/png?text=Miguel',
				imageAlt: 'Retrato de Miguel Toeldano'
			},
			future: 'Pronto se sumará más talento multidisciplinario.'
		},
		cta: {
			title: 'Únete a nuestra lista de novedades',
			subtitle: 'Recibe lanzamientos, betas cerradas y aprendizajes directamente en tu correo.',
		...
		projectPages: {
			sefone: {
				hero: {
					...
					imagePlaceholder: 'https://placehold.co/900x600/png?text=Sefone+Preview',
				...
				overview: {
					...
					placeholder: 'https://placehold.co/600x400/png?text=Routines+Dashboard',
					...
					items: [
						{
							...
							description: 'Notificaciones que respetan tus momentos importantes y reaccionan a cambios en el clima.'
						},
						{
							title: 'Modo familia',
							description: 'Configura perfiles para cada integrante y comparte avances con cuidadores o especialistas.'
						},
						{
							title: 'Insights accionables',
							description: 'Resúmenes semanales con recomendaciones prácticas y tendencias de protección.'
						}
					]
				},
				roadmap: {
					...
					items: [
						{
							...
							description: 'Disponibilidad en iOS y Android con rutinas solares completas.',
							product: 'sefone'
						},
						{
							quarter: 'Q3 2025',
							title: 'Reportes UV comunitarios',
							description: 'Usuarios comparten observaciones que enriquecen los datos oficiales.',
							product: 'sefone'
						},
						{
							quarter: 'Q4 2025',
							title: 'Integraciones con wearables',
							description: 'Compatibilidad con Apple Watch y dispositivos Wear OS.',
							product: 'sefone'
						}
					]
				},
					...
					items: [
						{
							...
							answer: 'Sefone se lanzará con un plan gratuito y opciones premium para funciones avanzadas.'
						},
						{
							question: '¿Quién valida las recomendaciones?',
							answer: 'Trabajamos con especialistas en dermatología y ciencia de datos para mantener modelos actualizados.'
						},
						{
							question: '¿En qué países estará disponible?',
							answer: 'Empezamos en México y ampliamos gradualmente a Latinoamérica durante 2025.'
						}
					]
				},
				cta: {
					title: 'Recibe acceso prioritario y novedades de Sefone',
					subtitle: 'Sé de las primeras personas en descubrir nuevas funciones y eventos de la comunidad.',
			...
			minervax: {
				hero: {
					...
					imagePlaceholder: 'https://placehold.co/900x600/png?text=Minervax+Preview',
				...
				overview: {
					...
					placeholderAlt: 'Ilustración de personas colaborando en seguridad ciudadana'
				},
				features: {
					...
					items: [
						{
							...
							description: 'Panel de verificación comunitaria que valida reportes antes de escalar una alarma.'
						},
						{
							title: 'Protocolos guiados',
							description: 'Instrucciones paso a paso para actuar en situaciones de emergencia.'
						},
						{
							title: 'Redes locales',
							description: 'Crea células de confianza con tus contactos y vecindario para compartir información relevante.'
						}
					]
				},
				roadmap: {
					...
					items: [
						{
							...
							description: 'Lanzamiento con vecindarios seleccionados y grupos de respuesta rápida.',
							product: 'minervax'
						},
						{
							quarter: 'Q3 2025',
							title: 'Mapa colaborativo nacional',
							description: 'Expansión a nuevas ciudades con mejores filtros y capas de información.',
							product: 'minervax'
						},
						{
							quarter: 'Q4 2025',
							title: 'Integraciones con instituciones',
							description: 'Enlaces directos con líneas de auxilio y autoridades locales.',
							product: 'minervax'
						}
					]
				},
					...
					items: [
						{
							...
							answer: 'Priorizamos a comunidades organizadas y aliadas que puedan colaborar activamente con reportes.'
						},
						{
							question: '¿Cómo se maneja la privacidad?',
							answer: 'Los datos personales se cifran y los reportes se anonimizarán antes de compartirse públicamente.'
						},
						{
							question: '¿La app será gratuita?',
							answer: 'Sí, la versión base será gratuita. Servicios premium para organizaciones llegarán después del lanzamiento público.'
						}
					]
				},
				cta: {
	...
	en: {
			...
			values: [
				{
					...
					description: 'Every experience starts with empathy and real-life needs.'
				},
				{
		...
		products: {
			title: 'Our products',
			caption: 'Two applications, one shared vision: care for and protect people.',
			cards: [
				{
					name: 'Sefone',
					status: 'available',
			...
			items: [
				{
					...
					description: 'Full experience with solar routines and hyperlocal alerts.',
					product: 'sefone'
				},
				{
					quarter: 'Q2 2025',
					title: 'Minervax closed beta',
					description: 'Community-driven pilot programs kicking off in Mexico City.',
					product: 'minervax'
				},
				{
					quarter: 'Q3 2025',
					title: 'Community UV reporting',
					description: 'Sefone members contribute observations that enrich official data.',
					product: 'sefone'
				},
				{
					quarter: 'Q4 2025',
					title: 'Collaborative alerts and widgets',
					description: 'Quick access to critical alerts on home screens and wearables.',
					product: 'minervax'
				}
			]
		},
		...
		faq: {
			...
			caption: 'Answers to the most common questions about Artemisa Development.',
			items: [
				{
		...
		team: {
			...
			founder: {
				name: 'Miguel Toeldano',
				role: 'Founder',
				bio: 'Software engineer and product designer crafting accessible technology blending wellness and safety.',
				placeholder: 'https://placehold.co/400x400/png?text=Miguel',
				imageAlt: 'Portrait of Miguel Toeldano'
			},
			future: 'More multidisciplinary talent joining soon.'
		},
		cta: {
			title: 'Join our updates list',
			subtitle: 'Get launches, closed betas, and lessons straight to your inbox.',
			button: 'Keep me posted',
			placeholder: 'https://placehold.co/800x400/png?text=Newsletter'
		},
		contact: {
			title: 'Let’s connect',
			description: 'Questions, ideas, or partnerships? Reach out and let’s talk.',
			emailLabel: 'Email',
			emailValue: 'hola@artemisa.dev',
		...
		projectPages: {
					...
					items: [
						{
							...
							description: 'Notifications that respect your important moments and react to weather changes.'
						},
						{
							title: 'Family mode',
							description: 'Configure profiles for each member and share progress with caregivers or specialists.'
						},
						{
							title: 'Actionable insights',
							description: 'Weekly summaries with practical recommendations and protection trends.'
						}
					]
				},
				roadmap: {
					...
					items: [
						{
							quarter: 'Q1 2025',
							title: 'Public launch',
							description: 'Available on iOS and Android with complete solar routines.',
							product: 'sefone'
						},
						{
							quarter: 'Q3 2025',
							title: 'Community UV reporting',
							description: 'Members share observations that enrich official data sources.',
							product: 'sefone'
						},
						{
							quarter: 'Q4 2025',
							title: 'Wearable integrations',
							description: 'Compatibility with Apple Watch and Wear OS devices.',
							product: 'sefone'
						}
					]
				},
					...
					items: [
						{
							...
							answer: 'Sefone will launch with a free tier and premium options for advanced features.'
						},
						{
							question: 'Who validates the recommendations?',
							answer: 'We collaborate with dermatology specialists and data scientists to keep models up to date.'
						},
						{
							question: 'Where will it be available?',
							answer: 'We start in Mexico and expand across Latin America throughout 2025.'
						}
					]
				},
				cta: {
					title: 'Get priority access and Sefone updates',
					subtitle: 'Be among the first to discover new features and community events.',
			...
			minervax: {
				...
				overview: {
					...
					placeholder: 'https://placehold.co/600x400/png?text=Community+Safety',
					placeholderAlt: 'Illustration of people collaborating on community safety'
				},
				features: {
					...
					items: [
						{
							...
							description: 'A community verification panel reviews reports before escalating an alarm.'
						},
						{
							title: 'Guided protocols',
							description: 'Step-by-step instructions to act in emergency situations.'
						},
						{
							title: 'Local networks',
							description: 'Create trusted groups with your contacts and neighborhood to share relevant updates.'
						}
					]
				},
				roadmap: {
					...
					items: [
						{
							...
							description: 'Launch with selected neighborhoods and rapid-response groups.',
							product: 'minervax'
						},
						{
							quarter: 'Q3 2025',
							title: 'Nationwide collaborative map',
							description: 'Expansion to new cities with improved filters and data layers.',
							product: 'minervax'
						},
						{
							quarter: 'Q4 2025',
					...
					items: [
						{
							...
							answer: 'We prioritize organized communities and partner groups who can collaborate actively with reports.'
						},
						{
							question: 'How is privacy handled?',
							answer: 'Personal data is encrypted and reports are anonymized before being shared publicly.'
						},
						{
							question: 'Will the app be free?',
							answer: 'Yes, the base version will be free. Premium services for organizations will follow the public launch.'
						}
					]
				},
				cta: {
